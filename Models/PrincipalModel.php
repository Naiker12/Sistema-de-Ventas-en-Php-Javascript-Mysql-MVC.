...
class PrincipalModel extends Query{
   ...
   //producto relacionados con la categoria
    public function getProductosCat($id_categoria, $desde, $porPagina)
    {
     ...
     //Obtener total del productos relacionadoscon la categoria
    ...
    {
        $sql = "SELECT * FROM productos  WHERE nombre LIKE '%". $valor."%'  OR descripcion  LIKE '%". $valor."%' LIMIT 10";
         return $this->selectAll($sql);
    }
}
