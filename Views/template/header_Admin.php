...
<head>
    ...
    <link rel="icon" href="<?php echo BASE_URL ;?>assets/img/tienda/admin.png" type="image/x-icon">
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="<?php echo BASE_URL; ?>assets/img/tienda/3.jpeg" class="logo-icon" alt="logo icon">
                </div>
                <div>
                    <h4 class="logo-text text-primary"><?php echo TITLE; ?></h4>
                </div>
        ...
        <header>
            <div class="topbar d-flex align-items-center">
                <nav class="navbar navbar-expand">
                    <div class="mobile-toggle-menu"><i class="fa fa-bars text-success"></i>
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo BASE_URL; ?>assets/img/tienda/3.jpeg" class="user-img" alt="user avatar">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo BASE_URL . 'admin/salir'; ?>"><i class='bx bx-log-out-circle'></i><span>Cerrar Sesion</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
